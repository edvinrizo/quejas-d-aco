...
class Region (models.Model):
    id_region = models.AutoField('No. Region', db_column='id_region_PK', primary_key=True, editable=False)
...
class Departamento (models.Model):
    id_depto = models.AutoField('Id Departamento', db_column='id_depto_PK', primary_key=True, editable=False)
...
class Municipio (models.Model):
    ...
    id_muni = models.AutoField('Id Municipio', db_column='id_muni_PK', primary_key=True, editable=False)
